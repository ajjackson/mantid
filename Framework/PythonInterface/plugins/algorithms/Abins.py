...
class Abins(PythonAlgorithm):
    ...
    def _fill_s_workspace(self, s_points=None, workspace=None, protons_number=None, nucleons_number=None):
        ...
        if self._instrument.get_name() in AbinsModules.AbinsConstants.ONE_DIMENSIONAL_INSTRUMENTS:
            ...
            elif s_points.shape[0] == AbinsModules.AbinsParameters.q_size:
    ...
    def _fill_s_2d_workspace(self, s_points=None, workspace=None, protons_number=None, nucleons_number=None):
        ...
        q_bins = np.linspace(start=AbinsModules.AbinsConstants.Q_BEGIN,
                             stop=AbinsModules.AbinsConstants.Q_END,
                             num=AbinsModules.AbinsParameters.q_size + 1)
        q_bin_vals = np.linspace(start=AbinsModules.AbinsConstants.Q_BEGIN,
                                 stop=AbinsModules.AbinsConstants.Q_END,
